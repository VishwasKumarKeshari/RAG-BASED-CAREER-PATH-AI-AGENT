...
4. **Learning Resources**: Provide only Coursera and YouTube resources in this exact format, one per line: `- [Resource Title](https://...)`. Do not include any extra explanation text for resources.
